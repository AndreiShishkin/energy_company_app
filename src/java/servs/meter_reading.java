...
@WebServlet(name = "meter_reading", urlPatterns = {"/meter_reading"})
public class meter_reading extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String counter_read = request.getParameter("count_read");
        try (PrintWriter out = response.getWriter()) {
            Connection conn = ds.getConnection();
            String query = "INSERT INTO ANDREI.COUNTERS (ACCOUNT_NUMBER, COUNTER_NUMBER, COUNTER_READINGS)"
                    + " VALUES ('" + account_num + "', '" + counter_num + "',"
                    + " '" + counter_read + " ')";
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<p align='center'>Показания внесены</pz>");
